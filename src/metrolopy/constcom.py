...
G = gummy(6.67430e-11,0.00015e-11) # gravitational constant in m**3/kg s**2, CODATA 2022
...
earth_mass = gummy(3.986004418e14,8e5)/G # in kg
solar_mass = gummy(1.32712442099e20,1e10)/G # in kg
jupiter_mass = solar_mass/gummy(1.047348644e3,1.7e-5) # in kg
