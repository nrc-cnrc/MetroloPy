...
with _BuiltinLib():
    ...
    RatioUnit('part per million','ppm',Conversion(one,1e-6),add_symbol=True)
    RatioUnit('part per billion','ppb',Conversion(one,1e-9),add_symbol=True)
    RatioUnit('part per trillion','ppt',Conversion(one,1e-12),add_symbol=True)
    RatioUnit('part per quadrillion','ppq',Conversion(one,1e-15),add_symbol=True)